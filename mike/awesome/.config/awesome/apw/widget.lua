...
local color         = '#9ec400' -- foreground color of progessbar
local color_bg      = '#7a8530' -- background color
local color_mute    = '#d54e53' -- foreground color when muted
local color_bg_mute = '#8c3336' -- background color when muted
local mixer         = 'pavucontrol-qt' -- mixer command
